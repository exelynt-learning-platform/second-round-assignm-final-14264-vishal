...
public class UserController {
    ...
    public ResponseEntity<UserAuthResDto> register(@RequestBody UserRegisterReqDto request) {
        UserAuthResDto response = userService.register(request);
        return ResponseEntity.ok(response);
    }

    @PostMapping("/login")
    public ResponseEntity<UserAuthResDto> login(@RequestBody UserLoginReqDto request) {
